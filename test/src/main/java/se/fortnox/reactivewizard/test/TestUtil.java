...
public final class TestUtil {
	 ...
	 *
	 * @param asserter
	 *            a lambda expression doing assertions
	 * @return
	 */
	...
	public static <T extends Throwable> ThrowableAssert assertException(Throwable e, Class<T> type) {
		while(!type.isAssignableFrom(e.getClass())) {
