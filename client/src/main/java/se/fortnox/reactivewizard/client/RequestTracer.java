...
/**
 * Creates an identifier for this system based on host, artifact and version, which is added to outgoing requests for tracing purposes
 */
public class RequestTracer {
    ...
    public void addTrace(RequestBuilder request) {
        ...
        String xViaClientHeaderValue = Strings.isNullOrEmpty(referrer) ? appIdentifier
                : referrer + "," + appIdentifier;
        request.addHeader(HTTP_X_VIA_CLIENT_HEADER, xViaClientHeaderValue);
    }
}
