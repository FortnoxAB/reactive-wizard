...
public class ServerApiModule implements AutoBindModule {

    private final InjectAnnotatedScanner injectAnnotatedScanner;
    private final ServerConfig config;

    @Inject
    public ServerApiModule(InjectAnnotatedScanner injectAnnotatedScanner, ConfigFactory configFactory) {
