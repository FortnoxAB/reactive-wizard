...
public class MockHttpServerRequest extends HttpServerRequestImpl<ByteBuf> {
    ...
    public MockHttpServerRequest(String uri, HttpMethod httpMethod, UnicastSubject<ByteBuf> content) {
        this(null, new DefaultHttpRequest(HttpVersion.HTTP_1_1, httpMethod, uri), content);
    }

    public MockHttpServerRequest(String uri, HttpMethod httpMethod) {
        this(null, new DefaultHttpRequest(HttpVersion.HTTP_1_1, httpMethod, uri), noContent());
    }

    public MockHttpServerRequest(String url, HttpMethod httpMethod, String body) {
        this(null, new DefaultHttpRequest(HttpVersion.HTTP_1_1, httpMethod, url), toContent(body));

    }

    public MockHttpServerRequest(String url, HttpMethod httpMethod, byte[] body) {
        this(null, new DefaultHttpRequest(HttpVersion.HTTP_1_1, httpMethod, url), toContent(body));
